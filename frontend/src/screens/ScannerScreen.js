...
const ScannerScreen = ({ navigation, route }) => {
    ...
    // EXTRAEMOS EL PARÁMETRO PARA OCULTAR EL DISEÑO MANUAL
    // Si hideManual es true, no mostraremos esa opción.
    const { hideManual } = route.params || { hideManual: false };
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>
                        {hideManual 
                            ? "Captura una nueva imagen para extraer una paleta de colores profesional."
                ...
                <View style={styles.optionsContainer}>
                    ...
                    {/* 3. DISEÑO MANUAL - RENDERIZADO CONDICIONAL */}
                    {!hideManual && (
                        <TouchableOpacity 
